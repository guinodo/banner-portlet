...
<liferay-ui:search-container
	...
	<liferay-ui:search-container-results
		results="<%= BannerLocalServiceUtil.getBannersByGroupId(scopeGroupId, searchContainer.getStart(), searchContainer.getEnd()) %>"
		total="<%= BannerLocalServiceUtil.getCoutBannersByGroupId(scopeGroupId) %>" />
	...
	<liferay-ui:search-container-row
		...
		<liferay-ui:search-container-column-text name="link"
			property="link" />
		
		<liferay-ui:search-container-column-text name="status">
			<%= (banner.getStatus() == 1) ? "approved" : "Inativo" %>
			<liferay-ui:icon image='<%= (banner.getStatus() == 1) ? "top" : "close" %>' /> 
