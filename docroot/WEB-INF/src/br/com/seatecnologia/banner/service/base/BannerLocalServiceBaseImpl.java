...
package br.com.seatecnologia.banner.service.base;

import br.com.seatecnologia.banner.model.Banner;
import br.com.seatecnologia.banner.service.BannerLocalService;
import br.com.seatecnologia.banner.service.persistence.BannerPersistence;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.seatecnologia.banner.service.impl.BannerLocalServiceImpl}.
 * </p>
 *
 * @author Oney
 ...
 * @generated
 */
public abstract class BannerLocalServiceBaseImpl implements BannerLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link br.com.seatecnologia.banner.service.BannerLocalServiceUtil} to access the banner local service.
	 */
	...
	public Banner addBanner(Banner banner) throws SystemException {
		...
		banner = bannerPersistence.update(banner, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(banner);
			}
	...
	public Banner updateBanner(Banner banner, boolean merge)
		...
		banner = bannerPersistence.update(banner, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("br.com.seatecnologia.banner.model.Banner",
			bannerLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"br.com.seatecnologia.banner.model.Banner");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(BannerLocalServiceBaseImpl.class);
