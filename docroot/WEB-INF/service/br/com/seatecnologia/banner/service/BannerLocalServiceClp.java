...
public class BannerLocalServiceClp implements BannerLocalService {
	public BannerLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addBannerMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addBanner", br.com.seatecnologia.banner.model.Banner.class);

		_createBannerMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createBanner", long.class);

		_deleteBannerMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteBanner", long.class);

		_deleteBannerMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteBanner", br.com.seatecnologia.banner.model.Banner.class);
		...
		_getBannerMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getBanner", long.class);

		_getPersistedModelMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getBannersMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getBanners", int.class, int.class);

		_getBannersCountMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getBannersCount");

		_updateBannerMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateBanner", br.com.seatecnologia.banner.model.Banner.class);

		_updateBannerMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateBanner", br.com.seatecnologia.banner.model.Banner.class,
				boolean.class);
	...
	public br.com.seatecnologia.banner.model.Banner addBanner(
		...
		MethodHandler methodHandler = new MethodHandler(_addBannerMethodKey0,
				ClpSerializer.translateInput(banner));
	...
	public br.com.seatecnologia.banner.model.Banner createBanner(long bannerId) {
		...
		MethodHandler methodHandler = new MethodHandler(_createBannerMethodKey1,
				bannerId);
	...
	public void deleteBanner(long bannerId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteBannerMethodKey2,
				bannerId);
	...
	public void deleteBanner(br.com.seatecnologia.banner.model.Banner banner)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteBannerMethodKey3,
				ClpSerializer.translateInput(banner));
	...
	public br.com.seatecnologia.banner.model.Banner getBanner(long bannerId)
		...
		MethodHandler methodHandler = new MethodHandler(_getBannerMethodKey8,
				bannerId);
	...
	public java.util.List<br.com.seatecnologia.banner.model.Banner> getBanners(
		...
		MethodHandler methodHandler = new MethodHandler(_getBannersMethodKey10,
				start, end);
	...
	public int getBannersCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getBannersCountMethodKey11);
	...
	public br.com.seatecnologia.banner.model.Banner updateBanner(
		...
		MethodHandler methodHandler = new MethodHandler(_updateBannerMethodKey12,
				ClpSerializer.translateInput(banner));
	...
	public br.com.seatecnologia.banner.model.Banner updateBanner(
		...
		MethodHandler methodHandler = new MethodHandler(_updateBannerMethodKey13,
				ClpSerializer.translateInput(banner), merge);
	...
	private MethodKey _addBannerMethodKey0;
	private MethodKey _createBannerMethodKey1;
	private MethodKey _deleteBannerMethodKey2;
	private MethodKey _deleteBannerMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _getBannerMethodKey8;
	private MethodKey _getPersistedModelMethodKey9;
	private MethodKey _getBannersMethodKey10;
	private MethodKey _getBannersCountMethodKey11;
	private MethodKey _updateBannerMethodKey12;
	private MethodKey _updateBannerMethodKey13;
